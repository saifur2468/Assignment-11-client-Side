...
const MyPosts = () => {
  ...
  const fetchPosts = async () => {
    ...
    const url = isAdmin
      ? "https://volunter-server-iota.vercel.app/posts/all"
      : `https://volunter-server-iota.vercel.app/posts?email=${user.email}`;
  ...
  const handleDelete = async (id) => {
    ...
    const res = await fetch(
      `https://volunter-server-iota.vercel.app/posts/${id}?email=${user.email}`,
      { method: "DELETE" }
    );
    if (res.ok) {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await fetch(
        `https://volunter-server-iota.vercel.app/posts/${selectedPost._id}?email=${user.email}`,
        {
          method: "PUT",
